                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div style="width: 180px;">
                                        <select id="statusPieUnit" class="form-select">
                            ...
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <div id="physicalAvailability" class="availability-kpi">-</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <div id="useAvailability" class="availability-kpi">-</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div style="width: 180px;">
                                        <select id="chartUnit" class="form-select">
                                            <option value="ALL">Semua Unit</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div style="width: 180px;">
                                        <select id="availabilityRateUnit" class="form-select">
                                            <option value="ALL">Semua Unit</option>
                                        </select>
                                    </div>
                                </div>
